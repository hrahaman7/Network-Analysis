...
connecting_routes1 = connecting_routes.iloc[0:10000, 1:8]
...
connecting_routes2 = connecting_routes

for_g = nx.Graph()
for_g = nx.from_pandas_edgelist(connecting_routes2, source = 'source airport', target = 'destination apirport')
